  ...
  try {
    ...
    const wsCards = tenants.length === 0
      ...
      : tenants.map((t,i) => {
          ...
          return '<div style="background:#0c0c12;border:1px solid rgba(255,255,255,.07);border-radius:16px;padding:22px;position:relative;overflow:hidden">'
            ...
            + '<div style="background:#16161f;border-radius:10px;padding:12px"><div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,.3);margin-bottom:4px">Today</div><div style="font-size:22px;font-weight:800;color:#25D366">' + today + '</div></div>'
            + '</div>'
    ...
    res.send('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>Dashboard — Syncora</title><link rel="icon" type="image/png" href="/logo.png"/><link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet"/><style>'
      ...
      + '</style></head><body>'
      + '<div class="mob-bar"><img src="/logo_text.png" alt="Syncora" style="height:20px;filter:brightness(0) invert(1)"/><button class="hbg" onclick="toggleDrawer()"><span></span><span></span><span></span></button></div><div class="mob-ov" id="mob-ov" onclick="closeDrawer()"></div><div class="mob-dr" id="mob-dr"><a class="sb-link on" href="#" onclick="showTab("overview",this);closeDrawer();return false">Overview</a><a class="sb-link" href="#" onclick="showTab("workspaces",this);closeDrawer();return false">Workspaces</a><a class="sb-link" href="#" onclick="showTab("account",this);closeDrawer();return false">Account</a><div style="height:1px;background:rgba(255,255,255,.06);margin:12px 0"></div><a class="sb-link" href="/auth/logout">Sign out</a></div><aside class="sidebar"><div class="sb-top"><img src="/logo_text.png" alt="Syncora" style="height:24px;filter:brightness(0) invert(1)"/></div>'
      ...
      + '<div style="background:#0c0c12;border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:18px;position:relative;overflow:hidden"><div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,.3);margin-bottom:8px">Workspaces</div><div style="font-size:36px;font-weight:900;letter-spacing:-1px">' + tenants.length + '<span style="font-size:16px;color:rgba(255,255,255,.25);font-weight:500"> / ' + (maxWorkspaces === 999 ? '∞' : maxWorkspaces) + '</span></div><div style="position:absolute;bottom:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#25D366,transparent)"></div></div>'
      + '<div style="background:#0c0c12;border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:18px;position:relative;overflow:hidden"><div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,.3);margin-bottom:8px">Total messages</div><div style="font-size:36px;font-weight:900;letter-spacing:-1px;color:#a78bfa">' + totalMsgs.toLocaleString() + '</div><div style="position:absolute;bottom:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#8b5cf6,transparent)"></div></div>'
      + '<div style="background:#0c0c12;border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:18px;position:relative;overflow:hidden"><div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:rgba(255,255,255,.3);margin-bottom:8px">Today</div><div style="font-size:36px;font-weight:900;letter-spacing:-1px;color:#25D366">' + todayMsgs + '</div><div style="position:absolute;bottom:0;left:0;right:0;height:2px;background:linear-gradient(90deg,#25D366,transparent)"></div></div>'
      + '</div>'
