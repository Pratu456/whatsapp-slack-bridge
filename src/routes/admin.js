...
<div style="position:relative;display:block"><input type="password" name="pwd" placeholder="Admin password" autofocus style="box-sizing:border-box;width:100%;padding:12px 44px 12px 16px"/><button type="button" onclick="togglePw(this)" tabindex="-1" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#888;display:flex;align-items:center;padding:0"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button></div><p style="text-align:center;margin-top:10px;font-size:12px;color:#777">Forgot password? Update <code>ADMIN_PASSWORD</code> in Render environment.</p>
