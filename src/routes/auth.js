...
<div class="card">
  <a href="/" class="logo" style="display:block;text-decoration:none"><img src="/logo_text.png" alt="Syncora"/></a>
  ...
  <form method="POST" action="/auth/register" autocomplete="off"><input type="text" style="display:none" name="fake_user"/><input type="password" style="display:none" name="fake_pass"/>
    ...
    <div class="fg"><label>Password</label><div style="position:relative;display:flex;align-items:center"><input type="password" name="password" placeholder="Minimum 8 characters" required minlength="8" style="padding-right:42px;width:100%"/><button type="button" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#000;padding:4px;display:flex;align-items:center;z-index:10" onclick="togglePw(this)" tabindex="-1"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button></div></div>
...
<div class="card">
  ...
  <form method="POST" action="/auth/login">
    ...
    <div class="fg"><label>Password</label><div style="position:relative;display:flex;align-items:center"><input type="password" name="password" placeholder="Your password" required style="padding-right:42px;width:100%"/><button type="button" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:none;border:none;cursor:pointer;color:#000;padding:4px;display:flex;align-items:center;z-index:10" onclick="togglePw(this)" tabindex="-1"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button></div><a href="/auth/forgot-password" style="display:block;margin-top:8px;color:#25D366;font-size:12px;font-weight:600;text-decoration:none">Forgot password?</a></div>
