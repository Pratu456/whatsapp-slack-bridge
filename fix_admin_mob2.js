...
// Insert mobile card check at start of renderContacts (line 723, index 722)
const rcInsert = `function renderContacts(){
...
// Insert mobile card check at start of renderMessages (line 779, index 778)
const rmInsert = `function renderMessages(){
  if(window.innerWidth<700){
